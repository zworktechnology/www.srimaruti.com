        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form autocomplete="off" method="POST" action="{{ route('expense.update', ['id' => $data->id]) }}" enctype="multipart/form-data">
                                @method('PUT')
                                @csrf
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="form-control js-example-basic-single" name="staff_id" required>
                                                    ...
                                                    <option value="{{ $staffs->id }}" @if ($staffs->id === $data->namelist_id) selected='selected' @endif>{{ $staffs->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
