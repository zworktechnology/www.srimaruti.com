...
@section('content')
    <div class="row" style="overflow: hidden; margin: 80px;">
        <div class="col-lg-12">
                ...
                <div class="card-body">
                    <div class="invoice-title" style="display: flex;">
                        ...
                        <div class="col-10" style="text-align: center;">
                            <h1 style="color: #ea5c0b; font-family: 'Cinzel Decorative', cursive; font-weight: bold;">Sri
                                Maruti Inn</h1>
                            @if ($data->branch_id == 1)
                    ...
                    <div class="row" style="display: flex;">
                            ...
                            <div class="text-muted">
                                <div>
                                    <h5 class="font-size-16 mb-1">
                                        Mr / Ms : <span style="color: #acafb7;">{{ $data->customer_name }}</span>
                                    </h5>
                                </div>
                                <div class="mt-4">
                                    <h5 class="font-size-16 mb-1">
                                ...
                                <div class="mt-4">
                                    <h5 class="font-size-16 mb-1">Check In Date : <span
                                            style="color: #acafb7; font-size: 0.9rem;">{{ date('d M Y', strtotime($data->check_in_date)) }}</span>
                                        Time
                                ...
                                @if ($data->extended_date != '')
                                    <div class="mt-4 mb-4">
                                        <h5 class="font-size-16 mb-1">Check Out Date : <span style="color: #acafb7; font-size: 0.9rem;">{{ date('d M Y', strtotime($data->extended_date)) }}</span>
                                            Time : <span style="color: #acafb7; font-size: 0.9rem;">{{ date('h:i A', strtotime($data->extended_time)) }}</span></h5>
                                    </div>
                                @else
                                    <div class="mt-4 mb-4">
                                        <h5 class="font-size-16 mb-1">Check Out Date : <span style="color: #acafb7; font-size: 0.9rem;">{{ date('d M Y', strtotime($data->check_out_date)) }}</span>
                                            Time : <span style="color: #acafb7; font-size: 0.9rem;">{{ date('h:i A', strtotime($data->check_out_time)) }}</span></h5>
                                    </div>
                                @endif
                        ...
                        <div class="col-sm-4 col-4" style="text-align: end;">
                            <div class="text-muted text-sm-end">
                                <div>
                                    <h5 class="font-size-16 mb-1">
                                        Bill No : <span style="color: #acafb7;">{{ $data->booking_invoiceno }}</span>
                                    </h5>
                                </div>
                                <div class="mt-4">
                                    <h5 class="font-size-16 mb-1">
                        ...
                        <div class="row" style="display: flex;">
                            ...
                            <div class="col-sm-6 col-6" style="text-align: end;">
                                ...
                                <h6 class="m-0">For <span
                                        style="font-family: 'Cinzel Decorative', cursive; font-weight: bold;">Sri Maruti
                                        Inn</span></h6>
                            </div>
                        </div>
