    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form autocomplete="off" method="POST"
                action="{{ route('booking.extend', ['id' => $bookingDatas['id']]) }}">
                @method('PUT')
                @csrf
                <div class="row mb-4">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-sm-5">
                        <input type="date" class="form-control checkin_date"
                            id="checkin_date{{ $bookingDatas['id'] }}" name="checkin_date" placeholder="Enter here "
                            value="{{ $bookingDatas['chick_in_date'] }}">
                    </div>
                    <div class="col-sm-4">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-sm-5">
                        <input type="date" class="form-control" style="background: #d1d17b;" disabled
                            id="checkout_date" name="checkout_date" placeholder="Enter here "
                            value="{{ $bookingDatas['chick_out_date'] }}">
                    </div>
                    <div class="col-sm-4">
                        <input type="time" class="form-control" style="background: #d1d17b;" disabled
                            id="checkout_time" name="checkout_time" placeholder="Enter here "
                            value="{{ $bookingDatas['chick_out_time'] }}">
                    </div>
                </div>
                <div class="row mb-4">
                    <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">Extended Date Upto <span
                            style="color: red;">*</span></label>
                    <div class="col-sm-5">
                        <input type="date" class="form-control extended_date"
                            id="extended_date{{ $bookingDatas['id'] }}" name="extended_date" placeholder="Enter here ">
                    </div>
                    <div class="col-sm-4">
                        <input type="time" class="form-control" id="extended_time" name="extended_time"
                            placeholder="Enter here " value="{{ $timenow }}">
                    </div>
                </div>
                <div class="row mb-4">
                    <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">Total Days <span
                            style="color: red;">*</span></label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control no_of_days" style="color:green" name="no_of_days"
                            id="no_of_days{{ $bookingDatas['id'] }}" value="{{ $bookingDatas['days'] }}" />
                    </div>
                </div>
                <div class="row mb-4">
                                                        ...
                                                        $(document).on("keyup", '#discount_amount' + {{ $bookingDatas['id'] }},
                                                            function() {
                                                                ...
                                                                $('#discount_percentage' + {{ $bookingDatas['id'] }}).val(
                                                                    discount_in_percentage.toFixed(2));
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control not-allowed" style="background: #eee;"
                ...
                <div class="row mb-4" hidden>
                    ...
                    <div class="col-sm-3">
                        <input type="text" class="form-control additional_charge_notes"
                    ...
                    <div class="col-sm-9 row">
                        ...
                        @foreach ($bookingDatas['terms'] as $index => $term_arr)
                            @if ($term_arr['booking_id'] == $bookingDatas['id'])
                                <span class="col-sm-4">
                                    <input type="text" style="background: #c3b6eb;" class="form-control term"
