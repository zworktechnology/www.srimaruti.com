                                ...
                                <form autocomplete="off" method="POST"
                                        ...
                                        <div class="modal-body">
                                                                                    ...
                                                                                    <td
                                                                                        ...
                                                                                        @foreach ($room as $rooms)
                                                                                            @if ($rooms['id'] == $BookingRoomss['room_id'])
                                                                                                <input type="text"
                                                                                                    class="form-control customer_booked_room"
                                                                                                    disabled
                                            ...
                                            <div id="singleproof" style="display:none">
                                                ...
                                                <div class="row mb-4">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <a
                                                            href="asset/{{ $data->proofimage_one }}">{{ $data->proofimage_one }}</a>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div id="doubleproof" style="display:none">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-4">
                                                <a
                                                    href="asset/{{ $data->proofimage_two }}">{{ $data->proofimage_two }}</a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-9">
                                            <div style="display: flex;">
                                                ...
                                                <div><img class="rounded me-2" width="100" height="100" style="margin: 20px;" src="{{ asset($data->customer_photo) }}"/></div>
                                            </div>
                                                    ...
                                                    <div data-repeater-item class="inner mb-3 row">
                                                        ...
                                                        <div class="col-md-9 col-3">
                                                            <input type="text" class="form-control balance_amount"
                                                                style="background-color:#c7c21dad"
