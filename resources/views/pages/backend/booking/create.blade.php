                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        for (var i = 0; i < output; i++) {
                            ...
                            $("#prooffront").append("<img src=" + response['data'][i].proofimage_one +"' style='width: 200px !important; height: 150px !important; margin-right: 40px !important; margin-top: 25px !important;'>");
