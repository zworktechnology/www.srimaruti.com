    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                @include('pages.backend.staff.create')
            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <ul class="list-unstyled hstack gap-1 mb-0">
                                                <li>
                                                    <a href="{{ route('staff.edit', ['id' => $datas->id]) }}" class="btn btn-sm btn-soft-info">Edit</a>
                                                </li>
                                                <li>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <p class="text-muted font-size-16 mb-4">Are you surely want to delete {{ $datas->name }} staff and all of its record?.</p>
                                                </div>
                                                <div class="modal-footer">
                                                    <form autocomplete="off" method="POST" action="{{ route('staff.delete', ['id' => $datas->id]) }}">
                                                        @method('PUT')
                                                        @csrf
