    ...
    <div class="widget-area">
        <div class="container">
            <div class="row justify-content-between">
                    ...
                    <div class="widget footer-widget">
                        ...
                        <div class="as-widget-contact">
                            <div class="info-box">
                                ...
                                <p class="info-box_text">
                                    No. 1, Sakthi Avenue, Koil Marriage Hall Opp
                                </p>
                            </div>
                            <div class="info-box">
                                <div class="info-box_icon">
                                ...
                                <p class="info-box_text">
                                    <a href="mailto:samayapuram@srimaruti.com" class="info-box_link">samayapuram@srimaruti.com
                                    </a>
                                </p>
                            </div>
                            <div class="info-box">
                                ...
                                <p class="info-box_text">
                                    <a href="tel:+919659464249" class="info-box_link">+91 96594 64249</a>
                                    <a href="tel:04312670060" class="info-box_link">(0431) 2670 060</a>
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-xl-auto">
                    <div class="widget footer-widget">
                        <h3 class="widget_title">Gunaseelam</h3>
                        <div class="as-widget-contact">
                            <div class="info-box">
                                <div class="info-box_icon">
                                    <i class="fa-solid fa-location-dot"></i>
                                ...
                                <p class="info-box_text">
                                    No. 4, Mass Garden, Salem Main Road
                                </p>
                            </div>
                            <div class="info-box">
                                <div class="info-box_icon">
                                ...
                                <p class="info-box_text">
                                    <a href="mailto:gunaseelam@srimaruti.com" class="info-box_link">gunaseelam@srimaruti.com
                                    </a>
                                </p>
                            </div>
                            <div class="info-box">
                                ...
                                <p class="info-box_text">
                                    <a href="tel:+919025343955" class="info-box_link">+91 90253 43955</a>
                                    <a href="tel:04316275275" class="info-box_link">(0431) 6275 275</a>
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    <div class="copyright-wrap">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <p class="copyright-text">Copyright <i class="fal fa-copyright"></i> 2023
                        By
                        <a href="https://zworktechnology.com">Zwork Technology</a>. All Rights Reserved.</p>
                </div>
                <div class="col-lg-6">
