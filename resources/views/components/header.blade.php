...
<head>
    ...
    <!-- Favicons -->
    <link rel="shortcut icon" href="assets/frontend/image/logo.png">

    <!-- Google Fonts -->
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin="">
    <link href="../../../css2?family=DM+Sans:wght@400;500;700&family=Playfair+Display:wght@400;500;600;700;800;900&family=Roboto:wght@300;400;500;700&display=swap" rel="stylesheet">
    ...
    <!-- nice-select -->
    <link rel="stylesheet" href="{{ asset('assets/frontend/css/datetimepicker.min.css') }}">
    <!-- Theme Custom CSS -->
